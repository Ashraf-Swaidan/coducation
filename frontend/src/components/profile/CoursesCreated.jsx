...
import './styles/CoursesCreated.css'; // Import the new CSS file for custom styles

const CoursesCreated = ({ CreatedCourses, userInfo }) => {
  console.log(CreatedCourses, userInfo);
        ...
        {CreatedCourses && CreatedCourses.map(course => (
          <div className="course-card  " key={course.course_id}>
            ...
            <div className="course-content">
              ...
              <p className="course-author">You</p>
